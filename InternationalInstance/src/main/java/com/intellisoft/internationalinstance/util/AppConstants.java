...
//    public static  final  String METADATA_ENDPOINT=INTERNATIONAL_BASE_URL+"programs/T4EBleGG9mU/metadata.json";
    ...
    public static final String DATA_STORE_ENDPOINT=INTERNATIONAL_BASE_URL+"33/dataStore/master_indicator_templates/";
}
